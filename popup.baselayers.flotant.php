<div class="jump-window col col-xs-12 col-sm-12-col-md-2 col-lg-2 geovisor-flotant" style="width:300px;" id="popup-baselayers" data-minimizable="1" data-minimized-title="CAPA BASE">
	...
	<div class="jump-window-inner p20">
		...
		<div class="jump-window-header">
			...
			<div class="jump-window-icon-bar">
				<a class="jump-window-minimize" onclick="jwindow.minimize('popup-baselayers');" style="cursor:pointer;">
					<i class="fas fa-minus"></i>
				</a>
				<a class="jump-window-close" onclick="jwindow.close('popup-baselayers');" style="cursor:pointer;">
		...
		<!--
				...
				<div class="pretty p-default p-round" style="font-size:20px;">
					<input type="radio" checked="checked" name="radio-baselayers" onclick="geomap.map.setBaseLayer(geomap.map.baselayers.bing_aerials);">
					<div class="state">
