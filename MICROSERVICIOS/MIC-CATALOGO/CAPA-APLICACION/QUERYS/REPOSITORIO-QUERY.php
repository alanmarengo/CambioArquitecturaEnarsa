            ...
            {  
                case 0:  
                    ...
                    $query_parcial .= <<<EOD
                        ...
                        LEFT JOIN "MIC-CATALOGO".sub_proyecto sp ON sp.sub_proyecto_id = u.subclase_id -- añadir tabla sub proyecto
                        WHERE u.tipo_formato_solapa = 
                        EOD;

                    $query_parcial .= ' '.$solapa.' '.$auxiliar_extensiones_filtros;
                ...
                case 4:
                    ...
                    $query_parcial = "SELECT ".$lista_filtros_solapa[$x]."::BIGINT AS filtro_id,
                                      ...
                                      t.subclase_id::BIGINT AS valor_id,
                                      COUNT(*)::BIGINT AS total ";                                      
